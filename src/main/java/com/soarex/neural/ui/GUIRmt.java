...
public class GUIRmt extends JFrame {
    ...
    private JCheckBox manualPlotFreq;
    ...
    private GUIRmt() {
        ...
        manualPlotFreq.addActionListener(e -> manualPlotFreq());
    ...
    public static void evaluate(INDArray x, String dataSetName, boolean separateDataSet) {
        if (net != null && getThreadByName("soarex-neuro") == null) {
    ...
    private void saveLoadCfg(boolean save) {
        ...
        if (save) {
            ...
            try {
                ...
                plotFreq.setText(obj.get("plotFrequency").toString());
    ...
    private void manualPlotFreq() {
        plotFreq.setEnabled(manualPlotFreq.isSelected());
    }

    private void rngOff() {
        seedValue.setEnabled(randomSeedCheckBox.isSelected());
    }
    ...
    private void setVars() {
        ...
        if (manualPlotFreq.isSelected()) {
            plotFrequency = Integer.parseInt(plotFreq.getText());
        } else {
            plotFrequency = nEpochs;
        }
    ...
    private void onStart() {
        ...
        plotFreq.setText(String.valueOf(plotFrequency));
    ...
    private void $$$setupUI$$$() {
        ...
        panel1.setLayout(new GridLayoutManager(2, 8, new Insets(0, 10, 0, 10), -1, -1));
        ...
        panel1.add(fnDataPoints, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        fxMin = new JTextField();
        fxMin.setText("");
        fxMin.setVisible(true);
        panel1.add(fxMin, new GridConstraints(1, 4, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        fxMax = new JTextField();
        fxMax.setText("");
        panel1.add(fxMax, new GridConstraints(1, 6, 1, 2, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        iterCL = new JLabel();
        ...
        panel2.add(funcT, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel4.setLayout(new GridLayoutManager(2, 5, new Insets(0, 10, 10, 10), -1, -1));
        ...
        optionsMore.setLayout(new GridLayoutManager(6, 10, new Insets(0, 0, 0, 0), -1, -1));
        optionsMore.setVisible(true);
        ...
        optionsMore.add(layersCfg, new GridConstraints(0, 1, 1, 8, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label5 = new JLabel();
        label5.setText("Network config");
        ...
        label7.setText("Iterations");
        optionsMore.add(label7, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        label8.setText("Optimisation alg");
        optionsMore.add(label8, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        optimisationAlgo.setToolTipText("Optimization algorithm to use");
        optionsMore.add(optimisationAlgo, new GridConstraints(4, 1, 1, 9, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label9 = new JLabel();
        label9.setText("Loss function");
        optionsMore.add(label9, new GridConstraints(5, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        optionsMore.add(lossFunc, new GridConstraints(5, 1, 1, 9, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label10 = new JLabel();
        label10.setText("Plot frequency");
        label10.setToolTipText("How frequently should we plot the network output");
        label10.setVisible(true);
        optionsMore.add(label10, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        plotFreq = new JTextField();
        plotFreq.setEnabled(false);
        plotFreq.setText("4");
        plotFreq.setToolTipText("How frequently should plot network output");
        optionsMore.add(plotFreq, new GridConstraints(2, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label11 = new JLabel();
        label11.setText("Epochs");
        optionsMore.add(label11, new GridConstraints(1, 7, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        optionsMore.add(buttonEval, new GridConstraints(0, 9, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        epochsValue = new JTextField();
        epochsValue.setText("2000");
        epochsValue.setToolTipText("Number of epochs (full passes of the data)");
        optionsMore.add(epochsValue, new GridConstraints(1, 8, 1, 2, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        optionsMore.add(weightInit, new GridConstraints(2, 6, 1, 4, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label12 = new JLabel();
        label12.setText("Batch size");
        optionsMore.add(label12, new GridConstraints(3, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        label13.setText("Seed");
        optionsMore.add(label13, new GridConstraints(3, 4, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        optionsMore.add(seedValue, new GridConstraints(3, 5, 1, 4, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        manualPlotFreq = new JCheckBox();
        manualPlotFreq.setEnabled(true);
        manualPlotFreq.setSelected(false);
        manualPlotFreq.setText("Manually set");
        optionsMore.add(manualPlotFreq, new GridConstraints(2, 2, 1, 2, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label14 = new JLabel();
        label14.setText("Weight init");
        optionsMore.add(label14, new GridConstraints(2, 4, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        randomSeedCheckBox = new JCheckBox();
        randomSeedCheckBox.setHideActionText(false);
        randomSeedCheckBox.setSelected(true);
        randomSeedCheckBox.setText("rand");
        optionsMore.add(randomSeedCheckBox, new GridConstraints(3, 9, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
